...
def importCtraxData(rootDir, fileName, keyList=None):
    """Loads tracking data generated by Ctrax and saved as .mat file into python as numpy arrays"""
    ...
    indat = loadmat(rootDir + fileName)
    ...
    return numFrames, xPos, yPos, angle, flyID, maxFlyID


def importCtraxDataLong(npzFilePath, matFilePath):
